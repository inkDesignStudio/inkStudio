...
<div class="contact">
    <?php if ($lang === 'en'): ?>
        <form class="contact__form" action="<?php echo esc_url( admin_url('admin-ajax.php')); ?>" method="post">
            ...
            <h3 class="contact__title">Leave a request</h3>
            <h4 class="contact__subtitle">and we will contact you shortly;)</h4>
            <div class="contact__inner">
                <div class="contact__wrapper">
                    <input name="client-name" class="contact__input contact__input_name" placeholder="*Name" type="text" tabindex="1" required autofocus>
                    <input name="client-email" class="contact__input contact__input_email" placeholder="*Email" type="email" tabindex="2" required>
                </div>
                <input name="client-phone" class="contact__input contact__input_phone" placeholder="*Telephone number" type="tel" tabindex="3" required>
                <textarea name="client-comment" class="contact__input contact__input_comment" placeholder="*Comment" tabindex="5" ></textarea>
                <button name="submit" type="submit" class="btn contact__btn" data-submit="...Sending">submit</button>
            </div>
        </form>
    <?php  elseif( $lang === 'ru' ): ?>
        <form class="contact__form" action="<?php echo esc_url( admin_url('admin-ajax.php')); ?>" method="post">
